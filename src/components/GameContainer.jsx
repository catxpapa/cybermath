  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 relative">
      ...
      <div className="relative z-10">
        ...
        <button
          onClick={onExit}
          className="mt-4 text-neon-purple hover:text-neon-blue transition-colors duration-300"
        >
          EXIT MISSION
        </button>
      </div>
